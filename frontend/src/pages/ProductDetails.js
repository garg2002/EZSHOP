           ...
           {/***product details */}
           {
            ...
            (
              <div className='flex flex-col gap-1'>
                <p className='bg-red-200 text-red-600 uppercase px-2 rounded-full inline-block w-fit'>{data?.brandName}</p>
                <h2 className='text-2xl lg:text-4xl uppercase font-medium'>{data?.productName}</h2>
